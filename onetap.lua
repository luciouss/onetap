    ...
    function x:CreateTab(y)
        ...
        function E:CreateDropdown(y, Z, _)
            ...
            local function V(W)
                ...
                if G then
                    local a5, a6 = string.gsub(W, "onetap\\", "")
                    a1.Text = a5
                    _(W)
                end
            end
            local function a7(W)
                ...
                for B, C in next, W do
                    local a5, a6 = string.gsub(C, "onetap\\", "")
...
createConfig =
    ...
    function()
        ...
        writefile("onetap\\" .. configName.Text .. ".cfg", c:JSONEncode(bM))
        l.options.Config.updateList(listfiles("onetap"))
    end
)
saveConfig =
    aF:CreateButton(
